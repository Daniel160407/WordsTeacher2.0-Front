...
const Dictionary = ({ updatedWords, langueageId }) => {
    ...
    useEffect(() => {
        ...
        const fetchWords = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_URL}/wordsTeacher/dictionary?type=all&userid=${Cookies.get('userId')}&languageid=${Cookies.get('languageId')}&tests=${false}`, {
                        headers: {
